    ...
    if(!isEvolution)
        ...
        <div className={'m-10 flex justify-center gap-20 items-center font-serif text-lg'}>
            ...
            <div className={'flex flex-col items-center'}>
                ...
                <button className={'opacity-80 size-fit border-b-amber-800 rounded-xl bg-cyan-300 p-2 hover:bg-cyan-400 text-gray-900'} onClick={() => dispatch(setIsEvolution(true))}>Evolution</button>
            </div>
        </div>
    )
    return <Evolution />
